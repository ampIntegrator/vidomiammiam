...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.run(sql`CREATE TABLE \`pages_blocks_icons_box_items\` (
  	...
  	\`title\` text,
  	\`description\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_icons_box\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_icons_box_items_order_idx\` ON \`pages_blocks_icons_box_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_icons_box_items_parent_id_idx\` ON \`pages_blocks_icons_box_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_icons_box\` (
  	\`_order\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_icons_box_order_idx\` ON \`pages_blocks_icons_box\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_icons_box_parent_id_idx\` ON \`pages_blocks_icons_box\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_icons_box_path_idx\` ON \`pages_blocks_icons_box\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_title_figure_long_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`figure\` text,
  	\`title\` text,
  	\`description\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_title_figure_long\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_figure_long_items_order_idx\` ON \`pages_blocks_title_figure_long_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_figure_long_items_parent_id_idx\` ON \`pages_blocks_title_figure_long_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_title_figure_long\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`color\` text DEFAULT 'primary',
  	\`heading_level\` text DEFAULT 'h3',
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_figure_long_order_idx\` ON \`pages_blocks_title_figure_long\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_figure_long_parent_id_idx\` ON \`pages_blocks_title_figure_long\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_figure_long_path_idx\` ON \`pages_blocks_title_figure_long\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_figure_on_top_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`figure\` text,
  	\`title\` text,
  	\`description\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_figure_on_top\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_figure_on_top_items_order_idx\` ON \`pages_blocks_figure_on_top_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_figure_on_top_items_parent_id_idx\` ON \`pages_blocks_figure_on_top_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_figure_on_top\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_figure_on_top_order_idx\` ON \`pages_blocks_figure_on_top\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_figure_on_top_parent_id_idx\` ON \`pages_blocks_figure_on_top\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_figure_on_top_path_idx\` ON \`pages_blocks_figure_on_top\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_title_text_no_boxing\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`heading_level\` text DEFAULT 'h2',
  	\`separator_color\` text DEFAULT 'primary',
  	\`title\` text,
  	\`text\` text,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_text_no_boxing_order_idx\` ON \`pages_blocks_title_text_no_boxing\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_text_no_boxing_parent_id_idx\` ON \`pages_blocks_title_text_no_boxing\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_title_text_no_boxing_path_idx\` ON \`pages_blocks_title_text_no_boxing\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_fw_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_banner_order_idx\` ON \`pages_blocks_fw_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_banner_parent_id_idx\` ON \`pages_blocks_fw_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_banner_path_idx\` ON \`pages_blocks_fw_banner\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_fw_image\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`filter_color\` text DEFAULT 'danger',
  	\`quote_tag\` text DEFAULT 'h3',
  	\`quote\` text,
  	\`filter_opacity\` text DEFAULT '0.8',
  	\`enable_parallax\` integer DEFAULT true,
  	\`block_name\` text,
  	FOREIGN KEY (\`background_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_image_order_idx\` ON \`pages_blocks_fw_image\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_image_parent_id_idx\` ON \`pages_blocks_fw_image\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_image_path_idx\` ON \`pages_blocks_fw_image\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_fw_image_background_image_idx\` ON \`pages_blocks_fw_image\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_meta_related_keywords\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`keyword\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_meta_related_keywords_order_idx\` ON \`pages_meta_related_keywords\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_meta_related_keywords_parent_id_idx\` ON \`pages_meta_related_keywords\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`hero_simple_heading\` text,
  	\`hero_heading_color\` text DEFAULT 'primary',
  	\`meta_title\` text,
  	\`meta_image_id\` integer,
  	\`meta_description\` text,
  	\`meta_schema_type\` text,
  	\`meta_schema_custom_data\` text,
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_icons_box_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon\` text,
  	...
  	\`description\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_icons_box\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_icons_box_items_order_idx\` ON \`_pages_v_blocks_icons_box_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_icons_box_items_parent_id_idx\` ON \`_pages_v_blocks_icons_box_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_icons_box\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_icons_box_order_idx\` ON \`_pages_v_blocks_icons_box\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_icons_box_parent_id_idx\` ON \`_pages_v_blocks_icons_box\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_icons_box_path_idx\` ON \`_pages_v_blocks_icons_box\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_title_figure_long_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`figure\` text,
  	...
  	\`description\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_title_figure_long\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_figure_long_items_order_idx\` ON \`_pages_v_blocks_title_figure_long_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_figure_long_items_parent_id_idx\` ON \`_pages_v_blocks_title_figure_long_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_title_figure_long\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_figure_long_order_idx\` ON \`_pages_v_blocks_title_figure_long\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_figure_long_parent_id_idx\` ON \`_pages_v_blocks_title_figure_long\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_figure_long_path_idx\` ON \`_pages_v_blocks_title_figure_long\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_figure_on_top_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`figure\` text,
  	...
  	\`description\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_figure_on_top\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_figure_on_top_items_order_idx\` ON \`_pages_v_blocks_figure_on_top_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_figure_on_top_items_parent_id_idx\` ON \`_pages_v_blocks_figure_on_top_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_figure_on_top\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_figure_on_top_order_idx\` ON \`_pages_v_blocks_figure_on_top\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_figure_on_top_parent_id_idx\` ON \`_pages_v_blocks_figure_on_top\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_figure_on_top_path_idx\` ON \`_pages_v_blocks_figure_on_top\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_title_text_no_boxing\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_text_no_boxing_order_idx\` ON \`_pages_v_blocks_title_text_no_boxing\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_text_no_boxing_parent_id_idx\` ON \`_pages_v_blocks_title_text_no_boxing\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_title_text_no_boxing_path_idx\` ON \`_pages_v_blocks_title_text_no_boxing\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_fw_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_banner_order_idx\` ON \`_pages_v_blocks_fw_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_banner_parent_id_idx\` ON \`_pages_v_blocks_fw_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_banner_path_idx\` ON \`_pages_v_blocks_fw_banner\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_fw_image\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_image_order_idx\` ON \`_pages_v_blocks_fw_image\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_image_parent_id_idx\` ON \`_pages_v_blocks_fw_image\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_image_path_idx\` ON \`_pages_v_blocks_fw_image\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_fw_image_background_image_idx\` ON \`_pages_v_blocks_fw_image\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_version_meta_related_keywords\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`keyword\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_version_meta_related_keywords_order_idx\` ON \`_pages_v_version_meta_related_keywords\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_version_meta_related_keywords_parent_id_idx\` ON \`_pages_v_version_meta_related_keywords\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`parent_id\` integer,
  	\`version_title\` text,
  	\`version_hero_simple_heading\` text,
  	\`version_hero_heading_color\` text DEFAULT 'primary',
  	\`version_meta_title\` text,
  	\`version_meta_image_id\` integer,
  	\`version_meta_description\` text,
  	\`version_meta_schema_type\` text,
  	\`version_meta_schema_custom_data\` text,
  ...
  await db.run(sql`CREATE TABLE \`identity\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`logo_id\` integer NOT NULL,
  	\`site_name\` text DEFAULT 'Upto1' NOT NULL,
  	\`slogan\` text DEFAULT 'Expert en croissance digitale' NOT NULL,
  	\`address_street\` text,
  	\`address_additional_info\` text,
  	\`address_postal_code\` text,
  	\`address_city\` text DEFAULT 'Paris' NOT NULL,
  	\`address_region\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`identity_logo_idx\` ON \`identity\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`header_nav_items_mega_menu_slots_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`url\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`header_nav_items_mega_menu_slots\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`header_nav_items_mega_menu_slots_links_order_idx\` ON \`header_nav_items_mega_menu_slots_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`header_nav_items_mega_menu_slots_links_parent_id_idx\` ON \`header_nav_items_mega_menu_slots_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`header_nav_items_mega_menu_slots\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`header_nav_items_mega_menu_slots_order_idx\` ON \`header_nav_items_mega_menu_slots\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`header_nav_items_mega_menu_slots_parent_id_idx\` ON \`header_nav_items_mega_menu_slots\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`header_nav_items\` (
  	...
  	\`has_mega_menu\` integer DEFAULT false,
  	\`color\` text,
  ...
  await db.run(sql`CREATE INDEX \`header_nav_items_featured_post_idx\` ON \`header_nav_items\` (\`featured_post_id\`);`)
  await db.run(sql`CREATE TABLE \`header\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`cta_button_success_text\` text,
  	\`cta_button_success_url\` text,
  	\`cta_button_danger_text\` text,
  	\`cta_button_danger_url\` text,
  	\`cta_button_primary_text\` text,
  	\`cta_button_primary_url\` text,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  ...
  await db.run(sql`CREATE TABLE \`socials\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon_color\` text DEFAULT 'white' NOT NULL,
  	\`facebook\` text,
  	\`twitter\` text,
  	\`instagram\` text,
  	\`linkedin\` text,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.run(sql`DROP TABLE \`pages_blocks_icons_box_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_icons_box\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_title_figure_long_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_title_figure_long\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_figure_on_top_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_figure_on_top\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_title_text_no_boxing\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_fw_banner\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_fw_image\`;`)
  await db.run(sql`DROP TABLE \`pages_meta_related_keywords\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_icons_box_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_icons_box\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_title_figure_long_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_title_figure_long\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_figure_on_top_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_figure_on_top\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_title_text_no_boxing\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_fw_banner\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_fw_image\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_version_meta_related_keywords\`;`)
  ...
  await db.run(sql`DROP TABLE \`identity\`;`)
  await db.run(sql`DROP TABLE \`header_nav_items_mega_menu_slots_links\`;`)
  await db.run(sql`DROP TABLE \`header_nav_items_mega_menu_slots\`;`)
